...
graph TD
    ...
    MemberModule --> MemberProfileController["MemberProfileController"]
...
sequenceDiagram
    ...
    MC->>MS: borrowBook(memberId, bookId, role)

    MS->>MS: ตรวจสิทธิ์ (role ต้องเป็น member หรือ admin)
...
sequenceDiagram
    ...
    MC->>MS: returnBook(memberId, bookId, role)
